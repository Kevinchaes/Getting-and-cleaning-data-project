...
The file [CodeBook.md](CodeBook.md) describes the processing steps and variables used in **run_analysis.R** and supplements the README.txt included in the original downloaded archive.
